...
import com.andfrankly.android.app.pageFactory.LoginPageFactory;
import com.andfrankly.android.app.pageFactory.OnBoardingPageFactory;
import com.andfrankly.android.app.pageFactory.QuestionsPageFactory;
...
public class TestAndroidAppWithPageFactory extends BaseTest {
	private AndroidDriver<MobileElement> driver;
	private LoginPageFactory login;
	private OnBoardingPageFactory onBoarding;
	private QuestionsPageFactory questions;

	Logger logger = LoggerFactory
			.getLogger(TestAndroidAppWithPageFactory.class);

	private void initializePages() {
		login = new LoginPageFactory(driver);
		onBoarding = new OnBoardingPageFactory(driver);
		questions = new QuestionsPageFactory(driver);
	}
	...
	public void verifySecondQuestionAndAddComment() {
